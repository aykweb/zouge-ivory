    ...
    <div class="menu-wrapper">
      ...
      <div class="content tab-content" id="lunch">
        <article class="menu__item">
          ...
          <div class="menu__text">
            <h3>ランチ定食</h3>
            <p class="menu__cap">焼きおにぎり、季節の漬物、日替わり小鉢</p>
            <p class="menu__price">700円<span class="menu__subcap">《にゅうめん大盛り +50円》</span></p>
          </div>
        </article>
        <article class="menu__item">
          <div class="menu__pic">
          ...
          <div class="menu__text">
            <h3>定番にゅうめん</h3>
            <p class="menu__cap">滋味豊かな定番の味</p>
            <p class="menu__price">500円<span class="menu__subcap">《大盛り +50円》</span></p>
          </div>
        </article>
        <article class="menu__item">
          <div class="menu__pic">
          ...
          <div class="menu__text">
            <h3>時季限定にゅうめん</h3>
            <p class="menu__cap">あごだしすだちにゅうめん</p>
            <p class="menu__price">600円<span class="menu__subcap">《大盛り +50円》</span></p>
          </div>
        </article>
      ...
      <div class="content tab-content" id="dinner" hidden>
        <article class="menu__item">
          ...
          <div class="menu__text">
            <h3>ディナー定食</h3>
            <p class="menu__cap">焼きおにぎり、季節の漬物、汁物</p>
            <p class="menu__price">800円<span class="menu__subcap">《にゅうめん大盛り +50円》</span></p>
          </div>
        </article>
        <article class="menu__item">
          <div class="menu__pic">
